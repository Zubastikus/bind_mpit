	...
	<div class="container-fluid py-2 px-5 text-black-50">
		<div class="col-5">
  		...
  		<div class="col-7">
    		...
    		<a href="../cabinet/volunteers_info.php"><button type="button" class="btn btn-default pos-right mx-2 px-3" href="#"><span class="iconify" data-icon="eva:person-outline" style=""></span></button></a> 
  		</div>
	</div>
</header>
<main>
<div class="container-lg text-center pt-5">
	...
	<div class="d-flex text-center mx-auto categories mt-4" style="width: 533px;">
		...
		<a href="../cabinet/volunteers_rate.php?id=<?php echo $_GET['id'] ?>" class="text-decoration-none"><p class="py-2 px-4 mx-3 mr-auto">Рейтинг</p></a>
		...
		<div class="col-4 p-3">
			<div class="back p-5" style="">
				...
				<form class="mt-4">
					...
					<input type="text" name="telephone" placeholder="" class="mb-2 volunteer" value="<?php echo $user["telephone"] ?>" disabled="true"/>
					<p>Профессия</p>
					<input type="text" name="profession" placeholder="" class="mb-2 volunteer" value="<?php echo $user["profession"] ?>" disabled="true"/>
<!-- 					<p>Возраст</p>
					<input type="text" name="age" placeholder="" class="volunteer" value="17" disabled="true"/> -->
				</form>
			</div>
		</div>
		<div class="col-8 p-3">
			<form class="">
				<div class="back px-5 py-4" style="">
					...
					<input type="text" name="login" placeholder="" class="mb-2 volunteer" value="<?php echo $user["login"] ?>" disabled="true"/>
					<p>Полное имя</p>
					<input type="text" name="name" placeholder="" class="mb-2 volunteer" value="<?php echo $user["name"] ?>" disabled="true"/>
