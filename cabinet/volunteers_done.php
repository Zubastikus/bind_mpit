...
<div class="container-lg text-center pt-5">
	...
	<div class="d-flex text-center mx-auto categories mt-4" style="width: 533px;">
		...
		<a href="../cabinet/volunteers_rate.php?id=<?php echo $_GET['id'] ?>" class="text-decoration-none"><p class="py-2 px-4 mx-3 mr-auto">Рейтинг</p></a> <!-- АААААААААААААААа -->
		<p class="py-2 px-4 mr-3 active mr-auto">Выполненные заказы</p>
	</div>
	<div class="row mx-auto">
		<div class="col-6 px-3">
			<!-- нач -->
			<div class="my-3 mx-3" style="background-image: url('../img/фадеев николай.png'); background-size: 100% 100%; height: 25rem;">
				
			</div>
			<div class="my-3 mx-3" style="background-image: url('../img/куликова фатима.png'); background-size: 100% 100%; height: 25rem;">
				
			</div>
			<div class="my-3 m-3" style="background-image: url('../img/гущин лев.png'); background-size: 100% 100%; height: 25rem;">
				
			</div>
			<!-- заканч -->
		</div>
		<div class="col-6 px-3">
			<div class="my-3 mx-3" style="background-image: url('../img/попова екатерина.png'); background-size: 100% 100%; height: 25rem;">
				
			</div>
			<div class="my-3 mx-3" style="background-image: url('../img/маркин святослав.png'); background-size: 100% 100%; height: 25rem;">
				
			</div>
			<div class="my-3 mx-3" style="background-image: url('../img/семенова татьяна.png'); background-size: 100% 100%; height: 25rem;">
